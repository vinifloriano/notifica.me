    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.social}>
                <TouchableHighlight underlayColor='#fff' onPress={logIn}>
                    <FontAwesome5 style={styles.icon} size={55} color="#7777ff" name="facebook" />
                </TouchableHighlight>
                <TouchableHighlight underlayColor='#fff' onPress={signInWithGoogleAsync}>
                    <FontAwesome5 style={styles.icon} size={55} color="#ff6461" name="google" />
                </TouchableHighlight>
                <TouchableHighlight underlayColor='#fff'>
                    <FontAwesome5  style={styles.icon} size={55} color="#5555bb" name="linkedin" />
                </TouchableHighlight>
            </View>
            <View style={styles.register}>
                <Text style={styles.registerText}>Ainda não tem uma conta? </Text>
                <Text style={styles.registerText2} onPress={register}>Cadastre-se</Text>
            </View>
        </View>
    );
}
